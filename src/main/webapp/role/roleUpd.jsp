    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="role.html">用户维护</a></div>
        </div>
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							<li style="height:30px;">
								<a href="${AppPath }/role/role" ><i class="glyphicon glyphicon-role"></i> 用户维护</a> 
							</li>
							<li style="height:30px;">
								<a href="${AppPath }/role/role"  style="color:red;" ><i class="glyphicon glyphicon-king"></i> 角色维护</a> 
							</li>
							<li style="height:30px;">
								<a href="${AppPath }/permission"><i class="glyphicon glyphicon-lock"></i> 许可维护</a> 
							</li>
						</ul>
					</li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" id="roleUpdForm">
				  <div class="form-group">
					<label for="exampleInputPassword1">登陆账号</label>
					<input type="text" class="form-control" id="rname" name="rolename" value="${role.rolename }">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#btnUpdate").click(function(){
			    	...
			    	$.ajax({
			    		cache:false,
			    		url:"${AppPath}/role/roleUpd",
			    		type:"post",
			    		data:$("#roleUpdForm").serialize(),
