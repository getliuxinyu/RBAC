            ...
            <li style="padding-top:8px;">
				<div class="btn-group">
				  <button type="button" class="btn btn-default btn-success dropdown-toggle" data-toggle="dropdown">
					<i class="glyphicon glyphicon-role"></i> ${loginUser.user_name } <span class="caret"></span>
				  </button>
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							<li style="height:30px;">
								<a href="role.html" style="color:red;"><i class="glyphicon glyphicon-role"></i> 用户维护</a> 
							</li>
							<li style="height:30px;">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" id="roleAddForm">
				  <div class="form-group">
					<label for="exampleInputPassword1">角色名称</label>
					<input type="text" class="form-control" id="exampleInputPassword1" name="rolename" placeholder="请输入角色名称">
				  </div>
