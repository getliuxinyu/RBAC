			  ...
			  <div class="panel-body">
				<form role="form" id="userUpdForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="uaccount" name="user_account" value="${user.user_account }">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="uname" name="user_name" value="${user.user_name }">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" id="uemail" name="user_email" value="${user.user_email }">
